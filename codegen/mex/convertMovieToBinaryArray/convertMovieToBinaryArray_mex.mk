...
MAKEFILE = convertMovieToBinaryArray_mex.mk

include convertMovieToBinaryArray_mex.mki


SRC_FILES =  \
	convertMovieToBinaryArray_mexutil.c \
	convertMovieToBinaryArray_data.c \
	convertMovieToBinaryArray.c \
	mean.c \
	round.c \
	repmat.c \
	convertMovieToBinaryArray_initialize.c \
	convertMovieToBinaryArray_terminate.c \
	convertMovieToBinaryArray_api.c \
	convertMovieToBinaryArray_mex.c

MEX_FILE_NAME_WO_EXT = convertMovieToBinaryArray_mex
...
SYS_INCLUDE += -I "/Users/pwjones/Documents/MATLAB/codegen/mex/convertMovieToBinaryArray"
...
%.$(OBJEXT) : /Users/pwjones/Documents/MATLAB/codegen/mex/convertMovieToBinaryArray/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /Users/pwjones/Documents/MATLAB/codegen/mex/convertMovieToBinaryArray/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
