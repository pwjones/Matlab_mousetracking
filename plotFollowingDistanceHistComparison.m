function plotFollowingDistanceHistComparison(rew_cell, dist_cell, rew_cell2, dist_cell2, dist_thresh)
...
line([xmed xmed], [0 yl(2)], 'Color', dr, 'LineStyle', '--'); 
text(xmed, yl(2)+2, 1, ['median: ' num2str(xmed)], 'color', dr);
title('Trial Set 1');
set(gca, 'TickDir', 'out');
xlim(xl); ylim(yl);
...
text(xmed, yl(1)+2, ['median: ' num2str(xmed)], 'color', dr);
xlim(xl); ylim(yl);
title('Trial Set 2');
